...
public abstract class DesignObject extends Rectangle implements Cloneable
{
	...
	public static enum STATUS {SELECTED, MOVE, RESHAPE, INITIAL, RESIZE, EDIT, ERASE, ERASE_RESHAPE, CHANGE};
...
//		obj.menuList = null;
	...
	public void setFillPaint()
	{
		...
		this.braillePaint = BraillePaint.create(this.fillType, this.fillColor, dSize, this.getDotSpan(), !this.fillBack);
	}
